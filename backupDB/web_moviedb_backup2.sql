...
INSERT INTO `favorite_movie` VALUES (11,1022009,197);
...
CREATE TABLE `home_movie` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1022022 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `home_movie` VALUES (1022009,'Em có thích nước Mỹ không','Hành động','../../assets/img/interstella.png','https://www.youtube.com/embed/9H8CjHTNCtg','2h30ph','2023-5-4','phim hay'),(1022010,'Cô gái đến từ hôm kia','ngôn tình','../../assets/img/interstella.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h20ph','12-5-2023','Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem, fugit reiciendis? ....'),(1022011,'Alo tôi đến đây','hành động','../../assets/img/theRevenant.png','https://www.youtube.com/embed/9H8CjHTNCtg','2h30ph','2023-5-4','Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem, fugit reiciendis? ....'),(1022012,'Alo tôi đến đây nè','hành động','../../assets/img/theRevenant.png','https://www.youtube.com/embed/9H8CjHTNCtg','2h30ph','2023-5-4','Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem, fugit reiciendis? ....'),(1022013,'Chu dế mèn','tiểu thuyết','../../assets/img/die_hard.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2023-6-5','Phim nay la phim hanh dong'),(1022014,'Anh hung','hanh dong','../../assets/img/thewalk.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2023-5-4','phim dở lắm đừng xem'),(1022015,'Anh hung 2','hanh dong','../../assets/img/thewalk.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2023-5-4','phim hay'),(1022016,'Lat mat','action','../../assets/img/die_hard.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h58p','2023-05-1','phim test'),(1022017,'Anh hung 23','hanh dong','../../assets/img/thewalk.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2923-5-4','phim hay'),(1022018,'Anh hung 234','hanh dong','../../assets/img/theRevenant.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2023-4-4','phim hay'),(1022019,'Anh hung gio','hanh dong','../../assets/img/theRevenant.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h30ph','2023-4-3','phim hay'),(1022020,'hehe','magic','http://127.0.0.1:5500/home/templates/src/assets/img/interestella.png','https://www.youtube.com/embed/9H8CjHTNCtg','1h20p','2023-05-16','hay lam'),(1022021,'Co gai den tu hom qua','Tinh cam','http://127.0.0.1:5500/home/templates/src/assets/img/tetris.jpg','https://www.youtube.com/embed/9H8CjHTNCtg','3h20ph','2023-05-16','phim hay');
...
CREATE TABLE `home_notification` (
  ...
  KEY `home_notification_user_id_a3272aae_fk_home_user_id` (`user_id`),
  CONSTRAINT `home_notification_movie_id_5c7d3ee3_fk_home_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `home_movie` (`id`),
  CONSTRAINT `home_notification_user_id_a3272aae_fk_home_user_id` FOREIGN KEY (`user_id`) REFERENCES `home_user` (`id`)
...
-- Dump completed on 2023-05-18  6:49:56
